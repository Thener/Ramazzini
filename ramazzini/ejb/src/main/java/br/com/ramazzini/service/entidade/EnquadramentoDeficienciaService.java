...
import br.com.ramazzini.dao.enquadramentoDeficiencia.EnquadramentoDeficienciaDao;
...
@Stateless
public class EnquadramentoDeficienciaService extends AbstractServiceImpl<EnquadramentoDeficiencia> {
	
	public EnquadramentoDeficiencia recuperarPorTipoEnquadramento(EnquadramentoDeficienciaEnum enquadramento) {
    	return ((EnquadramentoDeficienciaDao) getDao()).recuperarPorTipoEnquadramento(enquadramento);
    }	
}